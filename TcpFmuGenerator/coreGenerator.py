...
class Generator:
    ...
    def testBuildFMU(self):
        ...
        self.printMsg(
            "We are now test-building the FMU. You should first implement your FMU functionality and afterwards "
        ...
        try:
            ...
            if platform.system() == "Windows":
                ...
                pipe = subprocess.Popen(["build_VC_x64.bat"], shell=True, creationflags=subprocess.CREATE_NEW_CONSOLE,
                                        cwd=buildDir, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
                ...
                # call batch file to build the FMI library
                pipe = subprocess.Popen(["deploy.bat"], shell=True, creationflags=subprocess.CREATE_NEW_CONSOLE,
                                        cwd=buildDir, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
                # retrieve output and error messages
                outputMsg, errorMsg = pipe.communicate()
                # get return code
                ...
                pipe = subprocess.Popen(["bash", './build.sh'], cwd=buildDir, stdout=subprocess.PIPE,
                ...
                # shell file execution for Mac & Linux
                deploy = subprocess.Popen(["bash", './deploy.sh'], cwd=buildDir, stdout=subprocess.PIPE,
                                          stderr=subprocess.PIPE)
